...
const ProductCard = ({ product }) => {
    ...
    if (!product || !product.image) {
        return null; // or a fallback UI like "Loading..." or a placeholder card
    }
    return product && (
        <div onClick={() => { navigate(`/allProducts/${product.category.toLowerCase()}/${product._id}`); scrollTo(0, 0) }} className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white  max-w-56 w-full">
