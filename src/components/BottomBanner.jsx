...
function BottomBanner() {
    return (
        <div className='relative mt-24'>
            <img className='w-full hidden md:block' src={assets.bottom_banner_image} alt="banner_img" />
            <img className='w-full md:hidden ' src={assets.bottom_banner_image_sm} alt="banner_img" />
